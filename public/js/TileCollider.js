...
export default class TileCollider {
  ...
  checkX(entity) {
    ...
    const matches = this.tiles.searchByRange(x, x + entity.size.x, entity.position.y, entity.position.y + entity.size.y);
  ...
  test(entity) {
    ...
    const match = this.tiles.searchByPosition(entity.position.x, entity.position.y);
    this.checkY(entity);
    if(match){
